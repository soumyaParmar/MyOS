 ...
 * your controller. Think of it as airport security — each filter checks one thing:
...
public class SecurityConfig {
     ...
     * @Value injects from application.yml: app.frontend-url = ${FRONTEND_URL:http://localhost:3000}
     */
    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        http
             ...
             * If we kept CSRF enabled, every POST/PUT/DELETE request would need a CSRF token.
             *
             * AbstractHttpConfigurer::disable — A method reference (shorthand for csrf -> csrf.disable()).
             */
            ...
            .cors(cors -> cors.configurationSource(request -> {
                ...
                corsConfiguration.setAllowedOrigins(java.util.List.of(frontendUrl)); // Only our frontend
                corsConfiguration.setAllowedMethods(java.util.List.of("GET", "POST", "PUT", "DELETE", "OPTIONS"));
                corsConfiguration.setAllowedHeaders(java.util.List.of("*")); // Allow all headers
                corsConfiguration.setAllowCredentials(true); // Allow cookies to be sent cross-origin
            ...
            .authorizeHttpRequests(auth -> auth
                ...
                .requestMatchers("/api/auth/**").permitAll()   // Auth endpoints — public (can't require login to login!)
             ...
             * 1. JwtAuthenticationFilter checks for a JWT in cookies or Authorization header
             ...
             *
             * userInfoEndpoint — Configures how user data is fetched from the OAuth2 provider.
    ...
    /**
     * Configures the authentication provider — the component that verifies credentials.
     *
     ...
     * 4. If matched → authentication succeeds. If not → throws BadCredentialsException.
     */
    @Bean
     ...
     *
     * The AuthenticationManager is Spring Security's main interface for authentication.
